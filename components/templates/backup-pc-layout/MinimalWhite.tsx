...
export default function MinimalWhite({ name, class: cls, time, location, message, images }: Invitation) {
  return (
    <div className="min-h-screen bg-white flex flex-col items-center py-12 px-4 xl:px-10">
      <div className="w-full max-w-5xl xl:grid xl:grid-cols-[320px_minmax(0,520px)] xl:gap-12">
        {/* Header */}
        <div className="mb-10 xl:mb-0 xl:pt-8">
        ...
        {images && images.length > 0 && (
          <div className="relative h-80 rounded-2xl overflow-hidden mb-8 bg-gray-100 xl:h-[440px]">
        ...
        {images && images.length > 1 && (
          <div className="grid grid-cols-2 gap-2 xl:col-start-1 xl:mt-8">
        ...
        <p className="text-center text-gray-300 text-xs mt-10 xl:col-span-2">HNUE Invitation</p>
      </div>
    </div>
  )
}
