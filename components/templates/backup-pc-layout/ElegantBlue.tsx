...
export default function ElegantBlue({ name, class: cls, time, location, message, images }: Invitation) {
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col items-center py-12 px-4 xl:px-10">
      <div className="w-full max-w-5xl xl:grid xl:grid-cols-[320px_minmax(0,420px)] xl:gap-10">
      {/* Gold top bar */}
      <div className="w-full max-w-sm h-1 bg-gradient-to-r from-amber-400 via-yellow-300 to-amber-400 rounded-full mb-8 xl:mb-4 xl:mt-8 xl:col-start-1" />

      <div className="text-center mb-8 xl:text-left xl:mb-0 xl:col-start-1">
      ...
      <div className="bg-slate-800 rounded-2xl w-full max-w-sm overflow-hidden border border-slate-700 xl:max-w-[420px] xl:row-span-2 xl:justify-self-start">
      ...
      {images && images.length > 1 && (
        <div className="mt-4 flex gap-3 w-full max-w-sm xl:col-start-1 xl:mt-8">
      ...
      <div className="w-full max-w-sm h-px bg-gradient-to-r from-transparent via-amber-400 to-transparent mt-8 xl:col-span-2" />
      <p className="mt-4 text-slate-600 text-xs xl:col-span-2 xl:text-center">HNUE Invitation</p>
      </div>
    </div>
  )
}
