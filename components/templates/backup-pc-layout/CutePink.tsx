...
export default function CutePink({ name, class: cls, time, location, message, images }: Invitation) {
  return (
    <div className="min-h-screen bg-pink-50 flex flex-col items-center py-12 px-4 xl:px-10">
      <div className="w-full max-w-5xl xl:grid xl:grid-cols-[320px_minmax(0,420px)] xl:gap-10">
      {/* Header */}
      <div className="text-center mb-8 xl:text-left xl:mb-0 xl:pt-8">
      ...
      {/* Main card */}
      <div className="bg-white rounded-3xl shadow-lg w-full max-w-sm overflow-hidden border border-pink-100 xl:max-w-[420px] xl:justify-self-start">
        {/* Photo gallery */}
      ...
      {images && images.length > 1 && (
        <div className="mt-6 grid grid-cols-2 gap-3 w-full max-w-sm xl:col-start-1 xl:mt-8">
      ...
      <p className="mt-8 text-pink-300 text-xs xl:col-span-2 xl:text-center">Made with 💕 by HNUE Invitation</p>
      </div>
    </div>
  )
}
